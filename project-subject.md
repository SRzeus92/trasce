...
• You should always check, review, question, and test anything generated by AI.
...
guidelines and is not in contradiction with the subject’s
constraints.
...
module by using the default backend language (as specified above
in the mandatory part). However, this module will only be valid if you
...
a broad audience.
◦ Provide a language switcher or selector that allows users to choose the website’s
language based on their preferences.
